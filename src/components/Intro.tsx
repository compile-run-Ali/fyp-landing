...
const Intro = (props: Props) => {
  return (
    <div className='-mt-10 '>
      ...
      <div className='flex h-screen items-center  justify-between space-x-20 '>
        <div className='w-7/12 flex-col space-y-8'>
          ...
          <Button variant='default' className='bg-customGreen '>
            Request a Demo
          </Button>
        </div>
        <div className=' relative '>
          <Image
            ...
            className='rounded-xl hover:brightness-90'
            width={460}
            height={450}
